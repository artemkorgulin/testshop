...
class Cart
{
	...
	function getTotalSumm() // возвращает иготовую сумму корзины
	{
		...
		$item_position = new Product();// создаем модель для работы с продуктами
	...
	function printCart()
	{
		...
		$table_cart .= "<tr><td colspan='3'></td><td>К оплате: </td><td><strong> <span style='color: #7F0037'>" . floatval($total_summ) . " руб. </span></strong></td><td></td></tr></table>";
